...
class MyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    Paint paint = Paint();
    paint.color = Color(0xffffffff).withOpacity(_opacity);
    ...
    Paint paint2 = Paint();
    paint2.color = Color(0xffffffff);
    paint2.style = PaintingStyle.fill;

    canvas.drawCircle(Offset.zero, _centerCircleRadius, paint2);

    Paint paint3 = Paint();
    paint3.color = Color(0xffffffff).withOpacity(_opacity2);
    ...
    Paint paint4 = Paint();
    paint4.color = Color(0xffffffff).withOpacity(_opacity3);
